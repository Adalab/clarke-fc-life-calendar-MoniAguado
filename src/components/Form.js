        ...
        <form>
          ...
          <div className="icons__box">
            <div className="radio radio__happy">
              <label for="radio">
                <input type="radio" value="happy" name="option" />
                <img src={happy} className="icon happy"></img>
              </label>
            </div>
            <div className="radio radio__sad">
              <label for="radio">
                <input type="radio" value="sad" name="option"/>
                <img src={sad} className="icon sad"></img>
              </label>
            </div>
          </div>
          <div className="form__textarea">
            <input type="text" className="form__textarea" cols="100" rows="200" placeholder="Write something cool"></input>
          </div>
          <div className="form__buttons">
            <button className="button button__save">Guardar</button>
